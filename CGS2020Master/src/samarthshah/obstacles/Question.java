...
public class Question extends Obstacle {
	...
	public Question(String q, String[] a, int c, int x, int y, int width, int height, PApplet p) {
		...
		Platform p1 = new Platform(x + width/3, height/3 + y, width/3, 10, p);
		Platform p2 = new Platform(x + width/3, height/3*2 + y, width/3, 10, p);
